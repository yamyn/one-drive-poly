...
class OneDriveController {
    ...
    withToken = async (cb, pool, params) => {
        try {
            ...
            return await cb({ accessToken, ...params })
        } catch (error) {
    ...
    item = {
        listChildren: async (pool, params) => this.withToken(ApiService.listChildren, pool, params),
        createFolder: async (pool, params) => this.withToken(ApiService.createFolder, pool, params),
        uploadSimple: async (pool, params) => this.withToken(ApiService.uploadSimple, pool, params),
    }
